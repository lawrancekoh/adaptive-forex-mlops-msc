...
#include <FXATM/Managers/AdaptiveManager.mqh>  // MSc: ML Adaptive Integration
...
input string   InpEaName = "FXATM_MSc";                                // EA name for display purposes
...
void OnTick()
{
    ...
    //--- MSc: Update adaptive parameters on each new bar
